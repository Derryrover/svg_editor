...
var _user$project$Dice$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Dice$init = function (n) {
	return {ctor: '_Tuple2', _0: n, _1: _elm_lang$core$Platform_Cmd$none};
};
var _user$project$Dice$NewFace = function (a) {
	return {ctor: 'NewFace', _0: a};
};
var _user$project$Dice$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'Roll') {
			return {
...
var _user$project$Dice$Roll = {ctor: 'Roll'};
var _user$project$Dice$view = function (model) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$Dice$Roll),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('ROL'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _user$project$Dice$main = _elm_lang$html$Html$program(
	{
		init: _user$project$Dice$init(1),
		view: _user$project$Dice$view,
		update: _user$project$Dice$update,
		subscriptions: _user$project$Dice$subscriptions
	})();

var _user$project$RoseTree$flatten = function (_p0) {
	var _p1 = _p0;
	var childrenLists = A2(_elm_lang$core$List$map, _user$project$RoseTree$flatten, _p1._1);
	var parentList = {
		ctor: '::',
		_0: _p1._0,
		_1: {ctor: '[]'}
	...
	return A2(
		_elm_lang$core$List$append,
		parentList,
		_elm_lang$core$List$concat(childrenLists));
};
var _user$project$RoseTree$children = function (_p2) {
	var _p3 = _p2;
	return _p3._1;
};
var _user$project$RoseTree$root = function (_p4) {
	var _p5 = _p4;
	return _p5._0;
};
var _user$project$RoseTree$Rose = F2(
	function (a, b) {
		return {ctor: 'Rose', _0: a, _1: b};
	});
var _user$project$RoseTree$singleton = function (a) {
	return A2(
		_user$project$RoseTree$Rose,
		a,
		{ctor: '[]'});
};
var _user$project$RoseTree$addChild = F2(
	function (child, _p6) {
		var _p7 = _p6;
		return A2(
			_user$project$RoseTree$Rose,
			_p7._0,
			{ctor: '::', _0: child, _1: _p7._1});
	});
var _user$project$RoseTree$addChildren = F2(
	function (list, tree) {
		return A3(_elm_lang$core$List$foldr, _user$project$RoseTree$addChild, tree, list);
	});
var _user$project$RoseTree$updateRose = F2(
	function (a, _p8) {
		var _p9 = _p8;
		var rose = _user$project$RoseTree$singleton(a);
		return A2(_user$project$RoseTree$addChildren, _p9._1, rose);
	});
var _user$project$RoseTree$updateChildrenFlat = F2(
	function (f, tree) {
		var childs = _user$project$RoseTree$children(tree);
		var updatedChildren = A2(_elm_lang$core$List$map, f, childs);
		var rootTree = _user$project$RoseTree$singleton(
			_user$project$RoseTree$root(tree));
		return A2(_user$project$RoseTree$addChildren, updatedChildren, rootTree);
	});
var _user$project$RoseTree$findAndUpdate = F3(
	function (test, func, tree) {
		return test(tree) ? func(tree) : A2(
			_user$project$RoseTree$updateChildrenFlat,
...
var _user$project$SvgCircle$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$SvgCircle$init = function (n) {
	return {
		ctor: '_Tuple2',
		_0: {dice: n, x: 1, y: 1},
...
var _user$project$SvgCircle$Model = F3(
	function (a, b, c) {
		return {dice: a, x: b, y: c};
	});
var _user$project$SvgCircle$Y = function (a) {
	return {ctor: 'Y', _0: a};
};
var _user$project$SvgCircle$X = function (a) {
	return {ctor: 'X', _0: a};
};
var _user$project$SvgCircle$Dice = function (a) {
	return {ctor: 'Dice', _0: a};
};
var _user$project$SvgCircle$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'Dice':
				var _p1 = A2(_user$project$Dice$update, _p0._0, model.dice);
				var diceModel = _p1._0;
				var diceCommand = _p1._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{dice: diceModel}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$SvgCircle$Dice, diceCommand)
				};
			case 'X':
				var res = _elm_lang$core$String$toInt(_p0._0);
				var _p2 = res;
				if (_p2.ctor === 'Err') {
...
var _user$project$SvgCircle$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_user$project$SvgCircle$X),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_user$project$SvgCircle$Y),
								_1: {ctor: '[]'}
							},
							{ctor: '[]'}),
						_1: {
							...
							_1: {
								...
								_0: A2(
									...
									_user$project$SvgCircle$Dice,
									_user$project$Dice$view(model.dice)),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$SvgCircle$main = _elm_lang$html$Html$program(
	{
		init: _user$project$SvgCircle$init(1),
		view: _user$project$SvgCircle$view,
			...
			_1: {
				...
				_0: A2(
					...
					_elm_lang$core$List$concat(
						{
							ctor: '::',
							_0: A2(_user$project$RoseTreeHTML$doNeedSelect, _p3, _p2),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$core$List$map,
									...
									A2(
										_elm_lang$core$List$map,
										function (tree) {
											return {tree: tree, idHideSelect: _p2};
										},
										_user$project$RoseTree$children(_p3))),
								_1: {ctor: '[]'}
							}
						})),
				_1: {ctor: '[]'}
		...
		switch (_p4.ctor) {
			case 'Direction':
				...
				var roseTreeCmds = A2(
					...
					function (n) {
						var _p5 = A3(_user$project$RoseTreeHTML$updateHelperRose, _p7, _p8, n);
						var rose = _p5._0;
						var cmd = _p5._1;
						return cmd;
					},
				...
				var updatedRose = A2(
					_user$project$RoseTree$map,
					function (n) {
						var _p6 = A3(_user$project$RoseTreeHTML$updateHelperRose, _p7, _p8, n);
						var rose = _p6._0;
						var cmd = _p6._1;
						return rose;
					},
				...
				return {
					...
					_1: A2(
						...
						_user$project$RoseTreeHTML$Direction(_p7),
			...
			case 'CreatedRandom':
				...
				var func = _user$project$RoseTree$addChild(
					_user$project$RoseTree$singleton(
						_user$project$RoseTreeItem$init(_p4._1)));
			...
			case 'Add':
				return {
					...
					_1: A2(
						_elm_lang$core$Random$generate,
						_user$project$RoseTreeHTML$CreatedRandom(_p4._0),
			...
			default:
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							idHideSelect: _elm_lang$core$Maybe$Just(_p10)
						}),
					_1: A2(
						_elm_lang$core$Random$generate,
						_user$project$RoseTreeHTML$CreatedRandom(_p10),
						A2(_elm_lang$core$Random$int, 1, 1000000))
				};
		}
	});
...
var _user$project$SvgDisplay$drawLayer = function (tree) {
	...
	var treeCircle = _user$project$RoseTree$root(tree).item;
	return A2(
		_elm_lang$svg$Svg$g,
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$transform(
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(treeCircle.x),
						A2(
							_elm_lang$core$Basics_ops['++'],
							' ',
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(treeCircle.y),
								')'))))),
			_1: {ctor: '[]'}
		},
		_elm_lang$core$List$concat(
			{
				...
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$core$List$map, _user$project$SvgDisplay$drawLayer, children),
					_1: {ctor: '[]'}
				}
			}));
};
var _user$project$SvgDisplay$view = function (tree) {
	return A2(
...
var _user$project$SvgDisplay$a = 1;
...
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {
		item: _user$project$RoseTreeItem$init(1),
		roseTree: _user$project$RoseTreeHTML$init(_user$project$RoseTreeBuilder$result)
	},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$Main$Model = F2(
	function (a, b) {
		return {item: a, roseTree: b};
	});
var _user$project$Main$HTMLMessage = function (a) {
	return {ctor: 'HTMLMessage', _0: a};
};
		...
		{ctor: '[]'},
		{
				...
				},
				{
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								_elm_lang$html$Html$map,
								_user$project$Main$HTMLMessage,
								_user$project$RoseTreeHTML$view(model.roseTree)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$SvgDisplay$view(model.roseTree.tree),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Main$MsgItem = function (a) {
...
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'MsgItem') {
			var _p1 = A2(_user$project$RoseTreeItem$update, _p0._0, model.item);
			var item = _p1._0;
			var msg = _p1._1;
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{item: item}),
				_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$MsgItem, msg)
			};
		} else {
			var _p2 = A2(_user$project$RoseTreeHTML$update, _p0._0, model.roseTree);
			var roseTree = _p2._0;
			var cmd = _p2._1;
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{roseTree: roseTree}),
				_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$HTMLMessage, cmd)
			};
		}
	});
